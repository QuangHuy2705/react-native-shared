...
function TaskIcon({ color = "#000", ...rest }) {
  return (
    <Svg width="21" height="20" viewBox="0 0 21 20" fill="none" {...rest} xmlns="http://www.w3.org/2000/svg">
      <Path stroke={color} d="M10.0768 2.32416H6.96104C4.39854 2.32416 2.79187 4.13832 2.79187 6.70666V13.635C2.79187 16.2033 4.39104 18.0175 6.96104 18.0175H14.3143C16.8852 18.0175 18.4843 16.2033 18.4843 13.635V10.2783" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      ...
      <Path stroke={color} d="M13.1375 3.83545L16.9425 7.64045" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </Svg>
  );
}
